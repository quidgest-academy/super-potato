<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-album-propetitle-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ALBUM___PROPETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AlbumPropetitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ALBUM___PROPETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'ALBUM___PROPETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ALBUM___PROPETITLE____SeeMore',
					name: 'ALBUM___PROPETITLE____SeeMore',
					controller: 'PHOTO',
					action: 'ALBUM_PropeValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-album-propetitle',
				dismissAction: this.close,
				returnElement: 'ALBUM___PROPETITLE____see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-album-propetitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Album_Album_PropeValTitle',
