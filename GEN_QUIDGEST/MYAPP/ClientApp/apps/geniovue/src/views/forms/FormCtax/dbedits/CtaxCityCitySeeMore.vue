<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ctax-city-city-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CTAX____CITY_CITY_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CtaxCityCitySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CTAX____CITY_CITY_____SeeMore', false),

				interfaceMetadata: {
					id: 'CTAX____CITY_CITY_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CTAX____CITY_CITY_____SeeMore',
					name: 'CTAX____CITY_CITY_____SeeMore',
					controller: 'CTAX',
					action: 'CTAX_CityValCity'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ctax-city-city',
				dismissAction: this.close,
				returnElement: 'CTAX____CITY_CITY_____see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-ctax-city-city')
		},
