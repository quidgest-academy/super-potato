...
namespace CSGenio.framework
{
    ...
    public static partial class VersionInfo
    {
        ...
        /// </summary>
        public static int Version { get; } = 2537;

        /// <summary>
        /// Version of the database
        /// CI/CD: Database schema version
        /// </summary>
        public const int DatabaseSchema = 2537;

        /// <summary>
        /// Version of the database indexes
        /// CI/CD: Database index version
        /// </summary>
        public const int DatabaseIndex = 37;
        ...
        /// </summary>
        public const int Generation = 106;
        ...
        /// </summary>
        public static readonly DateTime GenerationDate = new DateTime(2026, 4, 27);
