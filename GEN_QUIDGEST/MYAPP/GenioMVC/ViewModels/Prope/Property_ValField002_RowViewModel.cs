...
public class Property_ValField002_RowViewModel : Models.Conta
{
	#region Constructors

	public Property_ValField002_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Property_ValField002_RowViewModel(UserContext userContext, CSGenioAconta val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
