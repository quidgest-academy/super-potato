...
{
	public class FOR_Menu_21_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<FOR_Menu_21_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "14605b80-6f4d-43a3-b9b3-accbd5a55db4";
...
// USE /[MANUAL FOR LIST_LIMITS 21]/
		...
		public FOR_Menu_21_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="FOR_Menu_21_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public FOR_Menu_21_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public FOR_Menu_21_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override List<Exports.QColumn> GetColumnsToExport()
		{
			...
			[
				...
				new Exports.QColumn(CSGenioAprope.FldDtconst, FieldType.DATE, Resources.Resources.DATA_DE_CONTRUCAO03489, 8, 0, true),
		...
		public void LoadToExportTemplate(out List<Exports.QColumn> columns)
		{
			...
			{
				new Exports.QColumn(CSGenioAprope.FldPhoto, FieldType.IMAGE, Resources.Resources.MAIN_PHOTO16044, 3, 0, true),
				new Exports.QColumn(CSGenioAprope.FldTitle, FieldType.TEXT, Resources.Resources.TITLE21885, 50, 0, true),
				new Exports.QColumn(CSGenioAprope.FldPrice, FieldType.CURRENCY, Resources.Resources.PRICE06900, 11, 2, true),
				new Exports.QColumn(CSGenioAprope.FldDescript, FieldType.MEMO, Resources.Resources.DESCRIPTION07383, 80, 5, true),
				new Exports.QColumn(CSGenioAprope.FldSize, FieldType.NUMERIC, Resources.Resources.SIZE__M2_57059, 8, 0, true),
				new Exports.QColumn(CSGenioAprope.FldBathnr, FieldType.NUMERIC, Resources.Resources.BATHROOMS_NUMBER52698, 2, 0, true),
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<FOR_Menu_21_RowViewModel>();
			...
			if (!tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
			{
				string defaultValue = "1";
				tableConfig.Filters.Add(new GroupFilter { Key = "filter_FOR_Menu_21_BUILDINGTY", Value = defaultValue });
			}

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_FOR_Menu_21_BUILDINGTY_1 = false;
				if (tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
					filter_FOR_Menu_21_BUILDINGTY_1 = tableConfig.GroupFilters["filter_FOR_Menu_21_BUILDINGTY"].Contains("1");
				else if (!tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
					filter_FOR_Menu_21_BUILDINGTY_1 = true;
				if (filter_FOR_Menu_21_BUILDINGTY_1)
				{

				}

				bool filter_FOR_Menu_21_BUILDINGTY_2 = false;
				if (tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
					filter_FOR_Menu_21_BUILDINGTY_2 = tableConfig.GroupFilters["filter_FOR_Menu_21_BUILDINGTY"].Contains("2");
				if (filter_FOR_Menu_21_BUILDINGTY_2)
				{
					groupFilters.Equal(CSGenioAprope.FldBuildtyp, "apartment");

				}

				bool filter_FOR_Menu_21_BUILDINGTY_3 = false;
				if (tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
					filter_FOR_Menu_21_BUILDINGTY_3 = tableConfig.GroupFilters["filter_FOR_Menu_21_BUILDINGTY"].Contains("3");
				if (filter_FOR_Menu_21_BUILDINGTY_3)
				{
					groupFilters.Equal(CSGenioAprope.FldBuildtyp, "house");

				}

				bool filter_FOR_Menu_21_BUILDINGTY_4 = false;
				if (tableConfig.GroupFilters.ContainsKey("filter_FOR_Menu_21_BUILDINGTY"))
					filter_FOR_Menu_21_BUILDINGTY_4 = tableConfig.GroupFilters["filter_FOR_Menu_21_BUILDINGTY"].Contains("4");
				if (filter_FOR_Menu_21_BUILDINGTY_4)
				{
					groupFilters.Equal(CSGenioAprope.FldBuildtyp, "other");
			...
			{
				// EPH
				crs = Models.Prope.AddEPH<CSGenioAprope>(ref u, crs, "ML21");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Prope.AddEPH<CSGenioAprope>(ref u, null, "ML21"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprope> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet for_menu_21Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(for_menu_21Conds);
			for_menu_21Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL FOR OVERRQ 21]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref for_menu_21Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL FOR OVERRQLSTEXP 21]/
...
// USE /[MANUAL FOR OVERRQLIST 21]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAprope.GetInformation(), QMVC_POS_RECORD, sorts, for_menu_21Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, for_menu_21Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapFOR_Menu_21(listing);
		...
		private List<FOR_Menu_21_RowViewModel> MapFOR_Menu_21(ListingMVC<CSGenioAprope> Qlisting)
		{
			List<FOR_Menu_21_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapFOR_Menu_21(row));
					i++;
				}
			}
		...
		/// to a FOR_Menu_21_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private FOR_Menu_21_RowViewModel MapFOR_Menu_21(CSGenioAprope row)
		{
			var model = new FOR_Menu_21_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL FOR VIEWMODEL_CUSTOM FOR_MENU_21]/
