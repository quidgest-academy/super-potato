...
public class Property_ValField001_RowViewModel : Models.Photo
{
	#region Constructors

	public Property_ValField001_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Property_ValField001_RowViewModel(UserContext userContext, CSGenioAphoto val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
