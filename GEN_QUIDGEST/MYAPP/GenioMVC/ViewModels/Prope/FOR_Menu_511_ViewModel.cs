...
{
	public class FOR_Menu_511_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<FOR_Menu_511_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "daa8c823-9af5-4811-880e-6d121fab2a86";
		...
		public override CriteriaSet StaticLimits
		{
			get
			{
				...
				// Limitations
				// Limit "SC"
				conditions.Equal(CSGenioAprope.FldSold, "1");
		...
		public override CriteriaSet BaseConditions
		{
			get
			{
				...
				if (Navigation.CheckKey("prope.sold"))
					conds.Equal(CSGenioAprope.FldSold, Navigation.GetValue("prope.sold"));
		...
		{
// USE /[MANUAL FOR LIST_LIMITS 511]/
		...
		public FOR_Menu_511_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="FOR_Menu_511_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public FOR_Menu_511_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public FOR_Menu_511_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<FOR_Menu_511_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Prope.AddEPH<CSGenioAprope>(ref u, crs, "ML511");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Prope.AddEPH<CSGenioAprope>(ref u, null, "ML511"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprope> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet for_menu_511Conds = CriteriaSet.And();
			...
			if (sorts.Count == 0)
			{
				...
				firstVisibleColumn ??= new FieldRef("prope", "photo");
			}
			// Limitations
			this.TableLimits ??= [];
			...
			conditions.SubSets.Add(for_menu_511Conds);
			for_menu_511Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL FOR OVERRQ 511]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref for_menu_511Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL FOR OVERRQLSTEXP 511]/
...
// USE /[MANUAL FOR OVERRQLIST 511]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAprope.GetInformation(), QMVC_POS_RECORD, sorts, for_menu_511Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, for_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapFOR_Menu_511(listing);
		...
		private List<FOR_Menu_511_RowViewModel> MapFOR_Menu_511(ListingMVC<CSGenioAprope> Qlisting)
		{
			List<FOR_Menu_511_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapFOR_Menu_511(row));
					i++;
				}
			}
		...
		/// to a FOR_Menu_511_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private FOR_Menu_511_RowViewModel MapFOR_Menu_511(CSGenioAprope row)
		{
			var model = new FOR_Menu_511_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL FOR VIEWMODEL_CUSTOM FOR_MENU_511]/

		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Prope", "Prope.ValCodprope", "Prope.ValZzstate", "Prope.ValPhoto", "Agent", "Agent.ValName", "Prope.ValDescript", "City", "City.ValCity", "Prope.ValSize", "Prope.ValBathnr", "Prope.ValDtconst", "Prope.ValBuildtyp", "Prope.ValTypology", "Prope.ValPrice", "Prope.ValCodagent", "Prope.ValCodcity"
		];
