...
public class FOR_Menu_311_RowViewModel : Models.Count
{
	#region Constructors

	public FOR_Menu_311_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public FOR_Menu_311_RowViewModel(UserContext userContext, CSGenioAcount val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
