...
public class Agent_CaddrValCountry_RowViewModel : Models.Caddr
{
	#region Constructors

	public Agent_CaddrValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Agent_CaddrValCountry_RowViewModel(UserContext userContext, CSGenioAcaddr val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
