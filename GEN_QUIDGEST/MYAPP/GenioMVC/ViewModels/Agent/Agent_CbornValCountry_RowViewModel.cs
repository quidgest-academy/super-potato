...
public class Agent_CbornValCountry_RowViewModel : Models.Cborn
{
	#region Constructors

	public Agent_CbornValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Agent_CbornValCountry_RowViewModel(UserContext userContext, CSGenioAcborn val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
