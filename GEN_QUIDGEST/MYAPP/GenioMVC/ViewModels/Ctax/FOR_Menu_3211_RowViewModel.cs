...
public class FOR_Menu_3211_RowViewModel : Models.Ctax
{
	#region Constructors

	public FOR_Menu_3211_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public FOR_Menu_3211_RowViewModel(UserContext userContext, CSGenioActax val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
