...
namespace GenioMVC.Controllers
{
	public partial class CountController : ControllerBase
	{
		...
		public CountController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL FOR CONTROLLER_NAVIGATION COUNT]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcount>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL FOR MANUAL_CONTROLLER COUNT]/
		...
		{
			return GenericRecalculateFormulas(formData, "count",
				(primaryKey) => Models.Count.Find(primaryKey, UserContext.Current, "FCOUNTRY"),
				(model) => formData.MapToModel(model as Models.Count)
			);
		}
		...
		{
			return base.GetDocumsTickets("COUNT", requestModel.FieldName, requestModel.KeyValue);
		}
