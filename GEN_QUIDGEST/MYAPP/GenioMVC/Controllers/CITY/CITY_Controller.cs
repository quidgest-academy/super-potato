...
// USE /[MANUAL FOR CONTROLLER_NAVIGATION CITY]/
...
// USE /[MANUAL FOR MANUAL_CONTROLLER CITY]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			...
			try
			{
				...
				{
					case "CITY____COUNTCOUNTRY_":	// Field (DB)
						{
							var model = new City_ViewModel(UserContext.Current) { editable = false };
							model.MapFromModel(row);
							model.Load_City____countcountry_(qs);
							result = model.TableCountCountry;
						}
						break;
					default:
						break;
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "CITY____COUNTCOUNTRY_":	// Field (DB)
						values = new City_ViewModel(UserContext.Current).GetDependant_CityTableCountCountry(Selected);
						break;
					default: break;
				}
