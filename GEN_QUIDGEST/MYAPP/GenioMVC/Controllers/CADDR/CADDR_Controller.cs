...
// USE /[MANUAL FOR INCLUDE_CONTROLLER CADDR]/

namespace GenioMVC.Controllers
{
	public partial class CaddrController : ControllerBase
	{
		private IChatbotService _aiService;
		public CaddrController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL FOR CONTROLLER_NAVIGATION CADDR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcaddr>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL FOR MANUAL_CONTROLLER CADDR]/
		...
		{
			return base.GetDocumsTickets("CADDR", requestModel.FieldName, requestModel.KeyValue);
		}
