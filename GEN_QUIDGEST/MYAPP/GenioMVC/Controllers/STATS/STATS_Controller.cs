...
namespace GenioMVC.Controllers
{
	public partial class StatsController : ControllerBase
	{
		...
		public StatsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL FOR CONTROLLER_NAVIGATION STATS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAstats>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL FOR MANUAL_CONTROLLER STATS]/
		...
		{
			return base.GetDocumsTickets("STATS", requestModel.FieldName, requestModel.KeyValue);
		}
