...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_FOR_MENU_61 = new NavigationLocation("STATISTICS11845", "FOR_Menu_61", "Stats") { vueRouteName = "menu-FOR_61" };


		//
		// GET: /Stats/FOR_Menu_61
