...
namespace CSGenio.business
{
	...
	public class CSGenioAphoto : DbArea
	{
		...
		public CSGenioAphoto(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL FOR CONSTRUTOR PHOTO]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codphoto", FieldType.KEY_INT);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("prope", new Relation("FOR", "forphoto", "photo", "codphoto", "codprope", "FOR", "forproperty", "prope", "codprope", "codprope"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaPluralDesignation="Photos album";
			info.DescriptionCav="PHOTO_ALBUM31473";
		...
		private static FieldRef m_fldPhoto = new FieldRef("photo", "photo");
		...
		private static FieldRef m_fldCodprope = new FieldRef("photo", "codprope");
        ...
        public static CSGenioAphoto search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
