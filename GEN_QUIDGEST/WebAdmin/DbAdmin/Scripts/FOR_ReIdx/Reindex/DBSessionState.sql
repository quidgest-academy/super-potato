...
SET @SQL = N'
CREATE DATABASE [ASPStateFOR]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateFOR'', FILENAME = N''' + @SQLDataFolder + 'ASPStateFOR.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateFOR_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateFOR_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateFOR_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateFOR_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateFOR_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateFOR] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateFOR] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
